                ...
                <div class="tab" role="tabpanel">
                    ...
                    <div class="tab-content tabs">
                        <div role="tabpanel" class="tab-pane fade in active" id="Section1">
                            <form action="{{route('montazhnik.update', $id->id)}}" method="post" class="form-horizontal">
                                @csrf
                                @method('patch')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="surname" name="surname" value="{{$id->surname}}">
                                </div>
